    ...
    <div class="bg-white p-6 rounded-lg shadow-md space-y-6">
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <select name="category_id" id="category_id" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" required>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="stock" id="stock" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" value="{{ old('stock') }}" required>
                @error('stock')
                    <small class="text-red-500 text-sm">{{ $message }}</small>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="price" id="price" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" step="0.01" value="{{ old('price') }}" required>
                @error('price')
                    <small class="text-red-500 text-sm">{{ $message }}</small>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <select name="is_active" id="is_active" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" required>
            ...
            <div class="mb-4">
                <label for="is_in_carousel" class="block text-lg font-semibold text-gray-700">Mostrar en Carrusel</label>
                <select name="is_in_carousel" id="is_in_carousel" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" required>
            ...
            <div class="mb-4">
                ...
                <input type="file" name="images[]" id="images" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500" multiple>
